...
7. Write the line of code to declare (but not initialize) a variable named "count" that can hold a whole number.
...
8. Write the line of code to declare and initialize a variable that holds a first name, in camel case. Initialize it to "David".
...
9. Write the line of code that creates a constant named MAXSIZE with the value 100;
