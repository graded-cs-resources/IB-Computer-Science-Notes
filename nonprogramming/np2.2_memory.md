...
4. **CPU Registers**:star: are the smallest, fastest memory, but they are usually considered as part of the CPU architecture. They are used only for values involved in the current *operations* of the processor. We will discuss them more in [Lesson 2.3](./np2.3_architecture.md)
